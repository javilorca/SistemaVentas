...
<html>
  <head>
    ...
    <title>ITVentas | www.javierlorca.net</title>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                 <!-- <img src="../public/dist/img/user1.png" class="user-image" alt="User Image">-->
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      www.javierlorca.net <br> Desarrollador de Software
                      <!--<small>javierlorca.net</small>-->
                    </p>
                  </li>
